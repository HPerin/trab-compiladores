...
{
       0,    79,    79,    82,    83,    84,    86,    87,    88,    90,
      92,    93,    96,    99,   100,   103,   104,   107,   108,   111,
     112,   113,   114,   117,   118,   119,   120,   121,   124,   127,
     128,   131,   132,   135,   136,   137,   138,   139,   140,   141,
     142,   143,   144,   147,   148,   149,   151,   154,   155,   159,
...
/* Line 1806 of yacc.c  */
#line 79 "parser.y"
    {(yyval.node) = (yyvsp[(1) - (1)].node); checkDeclarations((yyval.node), true); checkDeclarations((yyval.node), false); if (output) generate_code(output, (yyval.node));}
    break;
...
/* Line 1806 of yacc.c  */
#line 90 "parser.y"
    {(yyval.node) = ast_node_new(VARDEC, 0); ast_node_add_son((yyval.node), (yyvsp[(1) - (4)].node)); ast_node_add_son((yyval.node), (yyvsp[(2) - (4)].node)); ast_node_add_son((yyval.node), (yyvsp[(4) - (4)].node)); dataTypeSet((yyvsp[(2) - (4)].node)->hash_node, (yyvsp[(1) - (4)].node)->type); }
    break;
...
/* Line 1806 of yacc.c  */
#line 92 "parser.y"
    {(yyval.node) = ast_node_new(VECDEC_NOINIT, 0); ast_node_add_son((yyval.node), (yyvsp[(1) - (5)].node)); ast_node_add_son((yyval.node), (yyvsp[(2) - (5)].node)); ast_node_add_son((yyval.node), (yyvsp[(4) - (5)].node)); dataTypeSet((yyvsp[(2) - (5)].node)->hash_node, (yyvsp[(1) - (5)].node)->type);}
    break;
...
/* Line 1806 of yacc.c  */
#line 93 "parser.y"
    {(yyval.node) = ast_node_new(VECDEC_INIT, 0); ast_node_add_son((yyval.node), (yyvsp[(1) - (7)].node)); ast_node_add_son((yyval.node), (yyvsp[(2) - (7)].node)); ast_node_add_son((yyval.node), (yyvsp[(4) - (7)].node)); ast_node_add_son((yyval.node), (yyvsp[(7) - (7)].node)); dataTypeSet((yyvsp[(2) - (7)].node)->hash_node, (yyvsp[(1) - (7)].node)->type);}
    break;
...
/* Line 1806 of yacc.c  */
#line 103 "parser.y"
    {(yyval.node) = ast_node_new(FUNDEC_PARAMS, 0); ast_node_add_son((yyval.node), (yyvsp[(1) - (7)].node)); ast_node_add_son((yyval.node), (yyvsp[(2) - (7)].node)); ast_node_add_son((yyval.node), (yyvsp[(4) - (7)].node)); ast_node_add_son((yyval.node), (yyvsp[(6) - (7)].node)); 																					       ast_node_add_son((yyval.node), (yyvsp[(7) - (7)].node)); dataTypeSet((yyvsp[(2) - (7)].node)->hash_node, (yyvsp[(1) - (7)].node)->type);}
    break;
...
/* Line 1806 of yacc.c  */
#line 104 "parser.y"
    {(yyval.node) = ast_node_new(FUNDEC_NOPARAMS, 0); ast_node_add_son((yyval.node), (yyvsp[(1) - (6)].node)); ast_node_add_son((yyval.node), (yyvsp[(2) - (6)].node)); ast_node_add_son((yyval.node), (yyvsp[(5) - (6)].node)); ast_node_add_son((yyval.node), (yyvsp[(6) - (6)].node)); dataTypeSet((yyvsp[(2) - (6)].node)->hash_node, (yyvsp[(1) - (6)].node)->type);}
    break;
...
/* Line 1806 of yacc.c  */
#line 151 "parser.y"
    {(yyval.node) = ast_node_new(FUNC_DEC_PARAMS, 0); ast_node_add_son((yyval.node), (yyvsp[(1) - (3)].node)); ast_node_add_son((yyval.node), (yyvsp[(2) - (3)].node)); ast_node_add_son((yyval.node), (yyvsp[(3) - (3)].node)); dataTypeSet((yyvsp[(2) - (3)].node)->hash_node, (yyvsp[(1) - (3)].node)->type);}
    break;
